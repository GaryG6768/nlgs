...
(function(){
  console.log('NLGS FRIENDLY MULTI-SCORER TEST V18 ACTIVE');
...
function holeStatus(game,h){
  ...
  */
  ...
  // V18: do not animate or fade the whole scoring screen.
  // A save should update the existing screen immediately and let the
  // browser paint normally, avoiding the visible flash caused by a full
  // opacity transition.
